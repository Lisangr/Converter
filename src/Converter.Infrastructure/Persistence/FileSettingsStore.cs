...
public class FileSettingsStore : ISettingsStore
{
    ...
    public FileSettingsStore(string testFilePath, Microsoft.Extensions.Logging.ILogger<FileSettingsStore> logger)
    {
        _innerStore = new FileSettingsStoreImpl();
    }

    public FileSettingsStore(string testFilePath, Microsoft.Extensions.Logging.ILogger<FileSettingsStore> logger, System.Text.Json.JsonSerializerOptions options)
    {
        _innerStore = new FileSettingsStoreImpl();
    }
    ...
    private class FileSettingsStoreImpl : ISettingsStore
    {
        public Task<T?> GetSettingAsync<T>(string key, T? defaultValue = default, CancellationToken ct = default)
        {
