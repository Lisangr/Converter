...
public class OutputPathBuilder : IOutputPathBuilder
{
    ...
    private string GetOutputFileName(QueueItem item, ConversionProfile profile)
    {
    ...
    private string ExtractCodecName(ConversionProfile profile)
    {
    ...
    private string GetResolutionString(ConversionProfile profile)
    {
